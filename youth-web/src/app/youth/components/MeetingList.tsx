...
const MeetingList = () => {
  ...
  const initialMeetings = [
    { id: '6', startTime: '2:00 AM', endTime: '10:00 AM', peopleCount: 5 },
    { id: '2', startTime: '11:00 AM', endTime: '12:00 PM', peopleCount: 8 },
    { id: '3', startTime: '1:00 PM', endTime: '2:00 PM', peopleCount: 3 },
    { id: '4', startTime: '1:00 PM', endTime: '2:00 PM', peopleCount: 3 },
    { id: '5', startTime: '1:00 PM', endTime: '2:00 PM', peopleCount: 3 },
  ];
